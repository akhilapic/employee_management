...
messages: {
	...
	jQuery.ajax({
			...
			if(obj.status==true){
				...
				if(obj.employee_id==false){
					jQuery('#employee_id_error').html(obj.message);
					jQuery('#employee_id_error').css("display", "block");
				}
				else if(obj.emergency_contact_no==false){
					jQuery('#emergency_contact_no_error').html(obj.message);
					jQuery('#emergency_contact_no_error').css("display", "block");
				}
				else{
					jQuery('#employee_id_error').html('');
					jQuery('#emergency_contact_no_error').html('');
					jQuery('.result').html('');
				}
			}
			}
