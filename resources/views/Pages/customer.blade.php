			...
			<div class="col-12">
				<div class="card">
					<div class="border-bottom title-part-padding d-flex justify-content-between">
						...
						<a  href="{{url('add_user')}}" class="btn btn-info btn-sm">
							Add User
						</a>               
					</div>
					<div class="card-body">
...
s										<th style="width:500px;">Employee Id</th>
										<th style="width:500px;">Photograph</th>
										<th style="width:200px;">Agency</th>
										<th style="width:200px;">Emergency Contact No</th>
										...
										<th style="width:200px;">DOJ</th>
										<th style="width: 200px;">Date Of Training</th>
										<th style="width: 200px;">Work Station</th>
								...
								<tr>
									<!-- <td style=""><input type="checkbox" class="sub_chk" data-id="{{$user->id}}"></td> -->
										...
										<td>
										@if(!empty($user->image))
										<img src="{{$user->image}}" alt="user" width="30" height="30" class="rounded-circle">
										@else
										<img src="assets/admin/images/theme/user.png" alt="user" width="30" height="30" class="rounded-circle">
										@endif
									</td>
										...
										<td>{{$user->valid_upto}}</td>
										<td>{{$user->authorized_by}}</td>
										<td>{{$user->blood_group}}</td>
										<td>{{$user->level}}</td>
										<td>{{$user->dob}}</td>
										<td>{{$user->doj}}</td>
										<td>{{$user->date_of_training}}</td>
